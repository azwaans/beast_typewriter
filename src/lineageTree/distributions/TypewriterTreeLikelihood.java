...
public class TypewriterTreeLikelihood extends GenericTreeLikelihood {
    ...
    protected void initCore() {
        Log.info.println("INITCORE INITCOR INITCORE"  );
    ...
    public double calculateLogP() {
        ...
        Log.info.println("in calculateLogP, tree requires recalcultation "+ tree.somethingIsDirty());
    ...
    protected int traverse(final Node node) {
        ...
        if (!node.isRoot() && (update != Tree.IS_CLEAN || branchTime != m_branchLengths[nodeIndex])) {
            ...
            for (int i = 0; i < m_siteModel.getCategoryCount(); i++) {
                ...
                //the matrix to be updated is "probabilities"
